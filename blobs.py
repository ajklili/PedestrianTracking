...
BLOB_LIFE = 5               # life of blob in frames, if not seen
...
MOVE_LIMIT = 30             # maximum velocity of the blob. If outside this limit, velocity is disabled
MATCH_DISTANCE = 30         # maximum distance between blobs in the Hungarian algorithm matching step
